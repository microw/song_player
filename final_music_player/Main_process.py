...
class main_gui(QtWidgets.QMainWindow,QtCore.QObject,main_ui.Ui_MainWindow):
    ...
    def set_process_bar(self):#进度条及播放控制
        ...
        self.music_name_label.setText("歌曲名")
        ...
        self.procee_down_layout.addWidget(self.left_playconsole_widget)
        self.procee_down_layout.addWidget(self.right_process_bar)
    ...
    def set_sousuo_title(self,btn):
        ...
        btn.setStyleSheet("color:#bababa;border-right:1px solid white;")
    ...
    def pause_music(self):#暂停和播放音乐
        ...
        if(self.music_count!=0):
            ...
            self.statusbar.showMessage("当前没有播放歌曲",3000)
    ...
    def closeEvent(self, event):
        reply = QtWidgets.QMessageBox.question(self,'',"是否要最小化程序？",
